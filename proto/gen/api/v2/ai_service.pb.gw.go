...
func request_AiService_AiChat_0(ctx context.Context, marshaler runtime.Marshaler, client AiServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.AiChat(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AiService_AiChat_0(ctx context.Context, marshaler runtime.Marshaler, server AiServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AiRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.AiChat(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterAiServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AiServiceServer) error {
	...
	mux.Handle("POST", pattern_AiService_AiChat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/memos.api.v2.AiService/AiChat", runtime.WithHTTPPathPattern("/api/v2/ai"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AiService_AiChat_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_AiService_AiChat_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAiServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AiServiceClient) error {
	...
	mux.Handle("POST", pattern_AiService_AiChat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/memos.api.v2.AiService/AiChat", runtime.WithHTTPPathPattern("/api/v2/ai"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AiService_AiChat_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_AiService_AiChat_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v2", "ai"}, ""))
)

var (
	forward_AiService_AiChat_0 = runtime.ForwardResponseMessage
)
